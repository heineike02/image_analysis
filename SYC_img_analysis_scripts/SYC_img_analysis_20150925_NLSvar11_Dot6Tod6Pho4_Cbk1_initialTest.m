...
base_dir = '\\elsamad.ucsf.edu\Data\Instrumentation\microscope\SYC\20150925_NLSvar11_Dot6Tod6Pho4_Cbk1_initialTest\';
...
%phases = {'Pre'};
phases =  {'Dot6','Pho4','Dot6Cbk1'}; %'mCherry','Dot6Cbk1'};%,'five','longfour'};%{'Post'};
...
subfolder = {'1','2','4'}; %'3','4'};%,'5','long_4'};
shift_timing = [0 0 0];% 0];% 0 0]; %[0,10]; % assuming minutes    
...
imdirPhase.Dot6 = [base_dir,subfolder{1}, filesep]
imdirPhase.Pho4 = [base_dir, subfolder{2}, filesep]
...
fname_save = 'C:\Users\susanychen\Google Drive\UCSF Graduate Research (El-Samad)\DECODING PKA BY DOWNSTREAM EFFECTORS\20150925_NLSvar11_Dot6Tod6Pho4_Cbk1_initialTest\Dot6Pho4NLSvar11_20150925.mat';
...
time_calc_phase.Dot6 = strcat(base_dir, subfolder{1},'\acqdat.txt');
time_calc_phase.Pho4 = strcat(base_dir, subfolder{2}, '\acqdat.txt');
...
%phases = {'Pre'};
phases =  {'Tod6Cbk1'};%,'Dot6Cbk1'}; %'mCherry','Dot6Cbk1'};%,'five','longfour'};%{'Post'};
%These are the absolute times at which each phase starts.
% subfolder = {'pSYC83_10minBL_255auInten10_1point5x','pSYC83_nobluelight_1point5x', 'pSYC84_10minBL_255auInten4_OFF_1point5x',...
%     'pSYC84_10minBL_255auInten10_1point5x','pSYC84_nobluelight_1point5x'};
subfolder = {'5'};%,'long_4'}; %'3','4'};%,'5','long_4'};
shift_timing = [0];% 0];% 0];% 0];% 0 0]; %[0,10]; % assuming minutes    

%imdirPhase.Pre = [base_dir,'before_phospH',filesep];
%imdirPhase.Post = [base_dir,'5minBL_1fov_1point5x',filesep] %'\\elsamad.ucsf.edu\Data\Instrumentation\microscope\SYC\20150710_PhosphateDeplet_ASOE_TRpanel\phosphateDeplet'
imdirPhase.Tod6Cbk1 = [base_dir,subfolder{1}, filesep]
%imdirPhase.Dot6Cbk1 = [base_dir, subfolder{2}, filesep]
%imdirPhase.Dot6Cbk1 = [base_dir, subfolder{3}, filesep]
%imdirPhase.Dot6Cbk1 = [base_dir, subfolder{4}, filesep]
%imdirPhase.five = [base_dir, subfolder{5}, filesep]
%imdirPhase.six = [base_dir, subfolder{6}, filesep]
...
fname_save = 'C:\Users\susanychen\Google Drive\UCSF Graduate Research (El-Samad)\DECODING PKA BY DOWNSTREAM EFFECTORS\20150925_NLSvar11_Dot6Tod6Pho4_Cbk1_initialTest\Dot6Tod6NLSvar11_Cbk1Venus_20150925.mat';
...
%time_calc_phase.Pre = '\\elsamad.ucsf.edu\Data\Instrumentation\microscope\SYC\20150716_PhosphateDeplet_pH_ASOE_5TRs\before_phospH\acqdat.txt';
%time_calc_phase.Post = '\\elsamad.ucsf.edu\Data\Instrumentation\microscope\SYC\20150830_light-mediated_shuttling_pSYC84\5minBL_1fov_1point5x\acqdat.txt';
time_calc_phase.Tod6Cbk1 = strcat(base_dir, subfolder{1},'\acqdat.txt');
%time_calc_phase.Dot6Cbk1 = strcat(base_dir, subfolder{2}, '\acqdat.txt');
%time_calc_phase.Dot6Cbk1 = strcat(base_dir, subfolder{3}, '\acqdat.txt');
%time_calc_phase.Dot6Cbk1 = strcat(base_dir, subfolder{4}, '\acqdat.txt');
%time_calc_phase.five = strcat(base_dir, subfolder{5}, '\acqdat.txt');
%time_calc_phase.six = strcat(base_dir, subfolder{6}, '\acqdat.txt');
