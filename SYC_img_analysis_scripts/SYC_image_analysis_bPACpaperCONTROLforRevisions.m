...
base_dir = '/Volumes/Data/Instrumentation/microscope/SYC/20160721_bPACpaperControl/';
...
imdirPhase.(phases{1}) = [base_dir,'50min_blue_light_40uW',filesep];
%%
...
fname_save = '/Users/susanychen/temp_uscopy_Datafolder/bPACpaperControl_50min40uWJSO8-43.mat';
...
time_calc_phase.(phases{1}) = '/Volumes/Data/Instrumentation/microscope/SYC/20160721_bPACpaperControl/50min_blue_light_40uW/acqdat.txt';
