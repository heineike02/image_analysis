...
base_dir = '\\elsamad.ucsf.edu\Data\Instrumentation\microscope\SYC\20150903_SYC1-62_1-71_1-75_SDC_GD_1p5x\';
...
shift_timing = [0,3]; %[0,10]; % assuming minutes    
...
analysis_params.coarse_smooth = 25; %25;
analysis_params.local_smooth = 6; %3; 
%number greater than the maximum number of cells in an image.  Used for
%both analysis and tracking
analysis_params.maxcells = 300;

%Number of iterations to use in the deconvlucy algorithm.
analysis_params.deconvlucy_iterations = 5; %5;

%Parameters for finding maxima
analysis_params.close_max = 1;%6; %1;
analysis_params.far_max = 6;%7; % 6;
...
%Tracking Parameter: 
analysis_params.track_memory = 1; %2; % the lower the more stringent

%Tracking Parameter
analysis_params.min_points_for_traj = 20; %10; %4; %4; % at least 1/4 of the total length
...
fname_save = 'C:\Users\susanychen\Google Drive\UCSF Graduate Research (El-Samad)\DECODING PKA BY DOWNSTREAM EFFECTORS\20150903_SYC1-62_1-71_1-75_SDC_GD_1p5x\SYC1-62_1-71_1-75_SDC_GD_1p5x.mat';
...
time_calc_phase.Post = '\\elsamad.ucsf.edu\Data\Instrumentation\microscope\SYC\20150903_SYC1-62_1-71_1-75_SDC_GD_1p5x\Post\acqdat.txt';
...
time_calc_phase.Pre = '\\elsamad.ucsf.edu\Data\Instrumentation\microscope\SYC\20150903_SYC1-62_1-71_1-75_SDC_GD_1p5x\Pre\acqdat.txt';
