...
base_dir = '\\elsamad.ucsf.edu\Data\Instrumentation\microscope\SYC\20150916_light-mediated_shuttling_NLSvar3-29_log\';
...
%phases = {'Pre'};
phases =  {'Three','Five','Eight','Nine','Eleven','Fourteen', 'Fifteen','Twenty','TwentySeven','TwentyNine','TwentyFour', 'Original'};%{'Post'};
...
imdirPhase.Three = [base_dir,subfolder{1}, filesep]
imdirPhase.Five = [base_dir, subfolder{2}, filesep]
imdirPhase.Eight = [base_dir, subfolder{3}, filesep]
imdirPhase.Nine = [base_dir, subfolder{4}, filesep]
imdirPhase.Eleven = [base_dir, subfolder{5}, filesep]
imdirPhase.Fourteen = [base_dir, subfolder{6}, filesep]
imdirPhase.Fifteen = [base_dir, subfolder{7}, filesep]
imdirPhase.Twenty = [base_dir, subfolder{8}, filesep]
imdirPhase.TwentySeven = [base_dir, subfolder{9}, filesep]
imdirPhase.TwentyNine = [base_dir, subfolder{10}, filesep]
imdirPhase.TwentyFour = [base_dir, subfolder{11}, filesep]
imdirPhase.Original = [base_dir, subfolder{12}, filesep]
...
fname_save = 'C:\Users\susanychen\Google Drive\UCSF Graduate Research (El-Samad)\DECODING PKA BY DOWNSTREAM EFFECTORS\20150914_light-mediated_shuttling_NLSvar3-29\OrigNLSvar3-29_lightmediatedshuttling_20150916_logOD.mat';
...
time_calc_phase.Three = strcat(base_dir, subfolder{1},'\acqdat.txt');
time_calc_phase.Five = strcat(base_dir, subfolder{2}, '\acqdat.txt');
time_calc_phase.Eight = strcat(base_dir, subfolder{3}, '\acqdat.txt');
time_calc_phase.Nine = strcat(base_dir, subfolder{4}, '\acqdat.txt');
time_calc_phase.Eleven = strcat(base_dir, subfolder{5}, '\acqdat.txt');
time_calc_phase.Fourteen = strcat(base_dir, subfolder{6}, '\acqdat.txt');
time_calc_phase.Fifteen = strcat(base_dir, subfolder{7}, '\acqdat.txt');
time_calc_phase.Twenty = strcat(base_dir, subfolder{8}, '\acqdat.txt');
time_calc_phase.TwentySeven = strcat(base_dir, subfolder{9}, '\acqdat.txt');
time_calc_phase.TwentyNine = strcat(base_dir, subfolder{10}, '\acqdat.txt');
time_calc_phase.TwentyFour = strcat(base_dir, subfolder{11}, '\acqdat.txt');
time_calc_phase.Original = strcat(base_dir, subfolder{12}, '\acqdat.txt');
