...
fname_load = 'BlueLightNO_RFP_20151014';
val_to_plot = 'nf';
%val_to_plot = 'nmi';

% initialize
base_dir = 'C:\Users\susanychen\Google Drive\UCSF Graduate Research (El-Samad)\DECODING PKA BY DOWNSTREAM EFFECTORS\20151014-20151016_Pho4Pho84Pho5_Dot6Arx1_Lights\20151016_Pho4Pho5_Dot6Arx1_NOlight\';
experi_name = fname_load;
load([base_dir,experi_name])

phases =  {'BlueLightNo', 'BlueLightNo'};

well_order = {'No Blue Light'};
