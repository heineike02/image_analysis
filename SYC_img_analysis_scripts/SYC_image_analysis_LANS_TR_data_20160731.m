...
%base_dir = '/Volumes/Data/Instrumentation/microscope/SYC/20160726_Crz1BLcharact/';
base_dir = '/Volumes/microscope/SYC/20160726_Rtg3BLcharact/';
...
%phases = {'Pre'};
%phases =  {'ten','fifty','hun','twofivefive'};
%phases = {'Ash1'};
%phases = {'Gal4'};
%phases = {'Gln3'};
phases = {'ten'};
...
%shift_timing = [0,0,0,0]; %[0,10]; % assuming minutes    
shift_timing = [0];

%imdirPhase.Pre = [base_dir,'before_phospH',fiimlesep];
%imdirPhase.(phases{1}) = [base_dir,'Ash1',filesep];
%imdirPhase.(phases{1}) = [base_dir,'Gal4',filesep];
%imdirPhase.(phases{1}) = [base_dir,'Gln3',filesep];
imdirPhase.(phases{1}) = [base_dir,'255',filesep];
% imdirPhase.(phases{1}) = [base_dir,'Yap1',filesep];
%imdirPhase.(phases{1}) = [base_dir,'Yap2',filesep];
%imdirPhase.(phases{1}) = [base_dir,'Yap3',filesep];
...
fname_save = '/Users/susanychen/temp_uscopy_Datafolder/Rtg3LANS_20160731.mat';
...
time_calc_phase.(phases{1}) = 0.5;
%time_calc_phase.(phases{2}) = 0.5;
%time_calc_phase.(phases{3}) = 0.5;
%time_calc_phase.(phases{4}) = 0.5;
%time_calc_phase.(phases{5}) = 0.5;
%time_calc_phase.(phases{6}) = 0.5;
%time_calc_phase.(phases{7}) = 0.5;
...
%time_calc_phase.(phases{1}) = '/Volumes/Data/Instrumentation/microscope/SYC/20160726_Rtg3BLcharact/10/acqdat.txt';
%time_calc_phase.(phases{2}) = '/Volumes/Data/Instrumentation/microscope/SYC/20160726_Rtg3BLcharact/50/acqdat.txt';
%time_calc_phase.(phases{3}) = '/Volumes/Data/Instrumentation/microscope/SYC/20160726_Rtg3BLcharact/100/acqdat.txt';
%time_calc_phase.(phases{4}) = '/Volumes/Data/Instrumentation/microscope/SYC/20160726_Rtg3BLcharact/255/acqdat.txt';
