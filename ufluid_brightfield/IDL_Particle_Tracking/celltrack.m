function tracks = celltrack(xyzs,maxdisp,param)
...
% ; Image Processing
% ; CALLING SEQUENCE:
% ; result = celltrack( positionlist, maxdisp, param )
...
% ;             coordinate data to so that the celltrack knows to ignore the
...
% ;
% ;     IDL> res = celltrack(pos,5,mem=2)
% ;
% ;     celltrack will return the result 'res'
% ;         (x)      (y)      (t)          (id)
