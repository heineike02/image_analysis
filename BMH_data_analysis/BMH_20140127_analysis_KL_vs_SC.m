...
% Need to have "Ideal Cells" for both 1.0 and 1.5x optical zoom
...
imdirPhase.Post = 'C:\Users\Ben\Box Sync\Data\PKA_Project\20140127\SC_KLRPS_post_gluc_rep_1\'

%Gets background image for RFP
imbg = imread('C:\Users\Ben\Box Sync\Data\PKA_Project\20140123\27_SC_PKINES_pre_2\Pos0\img_000000000_RFP_000.tif');
...
pos_fnamesSP.SC = {'Pos3'}  %,'Pos3','Pos4','Pos5'} %{'Pos0','Pos1','Pos2','Pos3','Pos4','Pos5'};
channels = {'YFP','RFP', 'BF'}
