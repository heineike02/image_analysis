function all_tracks = BMH_20140524_analysis_sorb_resp()
...
base_dir = 'C:\Users\Ben\Box Sync\Data\PKA_Project\20140524_sorb_test\'
...
fname_saveSP.KL = 'sorb_test_procdata_KL.mat';
fname_saveSP.SC = 'sorb_test_procdata_SC.mat';
...
%A11 sites 1-4 SC Control
%A12 sites 1-4 KL Control
%B11 sites 1-4 SC 2% 0.25M Sorb
%B12 sites 1-4 KL 2% 0.25M Sorb
%C11 sites 1-4 SC 2% to no gluc
%C12 sites 1-4 KL 2% to no gluc
%D11 sites 1-4 SC 2% to 0.111M Sorb
%D12 sites 1-4 KL 2% to 0.111M Sorb

legend_vec = {'2% Gluc','2% Gluc + 0.25M Sorb', 'No Gluc + 0.111M Sorb','No Gluc'}
%Was control Gluc 0.111M, or SDC 2%? 

%Micromanager positions: Pos0, Pos1, etc.  
%JSO positions p1,p2,etc

wellvecSP.SC = {'A11','B11','C11','D11'};
wellvecSP.KL = {'A12','B12','C12','D12'};
Nsites = 4;
