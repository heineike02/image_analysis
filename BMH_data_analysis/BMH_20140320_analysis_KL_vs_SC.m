function BMH_20140320_analysis_KL_vs_SC()
...
base_dir = 'C:\Users\Ben\Box Sync\Data\PKA_Project\20140320\'
...
pos_fnamesSP.SC = {'p5', 'p6'}
pos_fnamesSP.KL = {'p11','p12'} 
channels = {'YFP','RFP','BF'}
...
if strcmp(channel_to_image,'RFP')
    imbg = imread('C:\Users\Ben\Box Sync\Data\PKA_Project\20140304\Ox_Gluc_Drop_Pre\RFP_p7_t2.tiff');
elseif strcmp(channel_to_image,'YFP')
    imbg = imread('C:\Users\Ben\Box Sync\Data\PKA_Project\20140304\Ox_Gluc_Drop_Pre\YFP_p3_t3.tiff');
else
