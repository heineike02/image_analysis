function all_tracks = BMH_20150416_osmo_then_GD()
%
...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20150416_osmo_then_GD\'
...
%SC 42: 
%A1 SDC then SDC @ 12 min
%B1 Osmo then SDC @ 12 min
%C1 SDC then 1x sorb. GD @ 12 min
%D1 Osmo then 1x sorb. GD @ 12 min
%E1 SDC then 1x sorb. GD @ 24 min
%F1 Osmo then 1x sorb. GD @ 24 min
%G1 SDC then 1x sorb. GD @ 36 min
%H1 Osmo then 1x sorb. GD @ 36 min
...
hold on
channel = 'YFP'
legend_vec_YFP = {'SDC -> SDC + 0.25M Sorb t6',
'SDC -> SDC + 0.25M Sorb t18', 
'SDC -> SDC + 0.25M Sorb t36', 
'SDC -> SDC + 0.25M Sorb t48', 
'SDC replaced + 0.25M Sorb t6', 
...
htitle = get(hleg,'Title');
%set(htitle,'String','Condition')
title('KL.Msn2, Osmo shock folowing media replacement')
xlabel('time')
ylabel('Nuclear Localization')
%}
