function all_tracks = BMH_20150602_Osmo_varied_then_GD()
%
...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20150602_Osmo_varied_then_GD\'
...
fname_saveSP.SC = '20150602_processed_data_SC.mat';
...
%Osmo shock varied followed by glucose dropout (0.37% glucose final
%osmo balanced with sorbitol relative to osmotic stress conentration)
%Row #	First pert.	[Sorbitol] final (M)	Fold (rel. to previous)	GD time (abs.)
%A5	SDC	0 GD t45
%B5	Osmo	0.125M		45
%C5	Osmo	0.25M  (previous)	45
%D5	Osmo	0.5M 		45
%E5	Osmo	0.75M		45
%F5	Osmo	1M		45
%G5	Osmo	1.25M		45
...
wellvecSP.SC = {'A5','B5','C5','D5','E5','F5','G5','H5'};
wellvecSP.KL = {};
Nsites = 4;
