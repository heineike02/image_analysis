function [] = BMH_20170119_gluc_to_sugar()
...
%base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20170119_SC_sugar_replacement_2\'

phases =  {'Pre', 'Post'}%,'Post_p2'} %,'Post'} 
shift_timing = [0,9]    %KL
%shift_timing = [0,13]    %SC

% Column 6 for KLac, 
% Column 3 for SC yEW051
% Column 4 for SC ySV076
%
%
