function BMH_20140402_analysis_KL_vs_SC()
...
base_dir = 'C:\Users\Ben\Box Sync\Data\PKA_Project\20140402\'
imdirPhase.Pre = [base_dir,'TM_Rap_Sorb_Pre\']
imdirPhase.Post = [base_dir,'TM_Rap_Sorb_Post\']
%imdirPhase.Rep = [base_dir,'Gluc_Rep_Post\']

%Pos 1-3: SC Sorb 0.125M
%Pos 4-6: KL Sorb 0.125M
%Pos 7-9: SC TM 1ug/ml
%Pos 10-12: KL TM 1ug/ml
%Pos 13-15: SC RAP 250nM
%Note: Position 15 has "difficult combinatorics encountered" error during
%tracking.  
%Pos 16-18: KL RAP 250nM
%Pos 19-21: SC Cont SDC
%Pos 22-24: KL Cont SDC
...
pos_fnamesSP.SC = {'p13','p14'} %, 'p14','p15'}
pos_fnamesSP.KL = {'p10','p11','p'} 
channels = {'YFP','RFP','BF'}
...
if bgimg == 0
    ...
    if strcmp(channel_to_image,'RFP')
         imbg = imread('C:\Users\Ben\Box Sync\Data\PKA_Project\20140402\TM_Rap_Sorb_Post\RFP_p4_t2.tiff');
    elseif strcmp(channel_to_image,'YFP')
         imbg = imread('C:\Users\Ben\Box Sync\Data\PKA_Project\20140402\TM_Rap_Sorb_Post\YFP_BG.tif');
    else
...
if strcmp(fname_conv,'JSO')
    ...
    for sp = 1:length(species_cell)
        ...
        for ph = 1:length(phases);
            ...
            summary_title = 'KL Cont (black), Tm 1ug/ml (red), Rap 250nM (blue)'
