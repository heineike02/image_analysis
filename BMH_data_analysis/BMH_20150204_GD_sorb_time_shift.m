function all_tracks = BMH_20150204_GD_sorb_time_shift()
%
...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20150204_GD_Sorb_change_times\'
...
%SC 42: 
%A11: GD -> GD + 0.25M Sorb t6 
%B11: SDC -> SDC + 0.25M Sorb t6 
%C11: GD -> GD + 0.25M Sorb t12 
%D11: SDC -> SDC + 0.25M Sorb t12 
%E11 GD -> GD + 0.25M Sorb t18 
%F11: SDC -> SDC + 0.25M Sorb t18 
%G11: 2uM NMPP1 -> 0.25M Sorb t6 + 2uM NMPP1 
%H11: 2uM NMPP1 -> 0.25M Sorb t18 + 2uM NMPP1

%Micromanager positions: Pos0, Pos1, etc.  
%JSO positions p1,p2,etc

%Hog wells {'A9','C9','E9','G9'}
wellvecSP.SC = {'A11','B11','C11','D11','E11','F11','G11','H11'};  %RFP_only 'C8','D8','E8'
wellvecSP.KL = {};
Nsites = 4;
