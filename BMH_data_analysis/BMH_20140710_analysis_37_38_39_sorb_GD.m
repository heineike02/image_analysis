function all_tracks = BMH_20140710_analysis_37_38_39_sorb_GD()
...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20140709_37_38_39_sorb_p5M\'
...
fname_saveSP.KL = '20140709_processed_data_KL_RFP.mat';
fname_saveSP.SC = '20140709_processed_data_SC_RFP.mat';

channels = {'BF','RFP','YFP'}
channel_to_image = 'RFP'

phases =  {'Pre','Post'} %,'Post'} 
shift_timing = [0,11.25]    
...
%A1 SC 37y1 SDC to SDC+0.5M Sorb
%B1 SC 37y2 SDC to SDC+0.5M Sorb
%C1 SC 38y1  SDC to SDC+0.5M Sorb
%D1 SC 38y2 SDC to SDC+0.5M Sorb
%E1 SC 11-38 SDC to SDC+0.5M Sorb
%F1 KL 39y1 SDC to SDC+0.5M Sorb
%G1 KL 39y2 SDC to SDC+0.5M Sorb
%H1 KL 29y SDC to SDC+0.5M Sorb


%A3 SC 37y1 SC 2% to no gluc + 0.111M sorb
%B3 SC 37y2 SC 2% to no gluc + 0.111M sorb
%C3 SC 38y1  SC 2% to no gluc + 0.111M sorb
%D3 SC 38y2 SC 2% to no gluc + 0.111M sorb
%E3 SC 11-38 SC 2% to no gluc + 0.111M sorb
%F3 KL 39y1 SC 2% to no gluc + 0.111M sorb
%G3 KL 39y2 SC 2% to no gluc + 0.111M sorb
%H3 KL 29y SC 2% to no gluc + 0.111M sorb

%SC 
legend_vec = {'SC 37y1 0.5M sorb','SC 38y2 0.5M sorb','SC 38y2 0.5M sorb','SC 38y2 0.5M sorb','11-38 0.5M sorb'};
    %'11-38 No gluc, 0.111M sorb'} %'39y 1 0.5M sorb','39y 1 No gluc, 0.111M sorb','39y 2 0.5M sorb','39y 2 No gluc, 0.111M sorb', '29y 1 0.5M sorb','29y 1 No gluc, 0.111M sorb'}

%Micromanager positions: Pos0, Pos1, etc.  
%JSO positions p1,p2,etc

wellvecSP.SC = {'A1','B1','C1','D1','E1'};
...
'print if you got to here'
figure(4)
clf 
hold on
legend_vec_RFP = {'(KL.MSN2) 39y 1 0.5M sorb','(KL.MSN2) 39y 1 No gluc, 0.111M sorb','(KL.MSN2) 39y 2 0.5M sorb','(KL.MSN2) 39y 2 No gluc, 0.111M sorb', '(KL.MSN2) 29y 1 0.5M sorb','(KL.MSN2) 29y 1 No gluc, 0.111M sorb'}
...
legend_vec_YFP = {'(SC.MSN2) 39y 1 0.5M sorb','(SC.MSN2) 39y 1 No gluc, 0.111M sorb','(SC.MSN2) 39y 2 0.5M sorb','(SC.MSN2) 39y 2 No gluc, 0.111M sorb'};

fname_saveSP.KL = '20140703_processed_data_KL_YFP.mat';
load([base_dir,fname_saveSP.(species)],'all_times_vec','all_tracks_vec','posvec') 
