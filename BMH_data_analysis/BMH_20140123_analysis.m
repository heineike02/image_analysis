...
pos_fnamesSP.KL = {'Pos2','Pos3','Pos4','Pos5'} %{'Pos0','Pos1','Pos2','Pos3','Pos4','Pos5'};
channels = {'YFP', 'BF'}
...
for sp = 1:length(species_cell)
    ...
    for ph = 1:length(phases);
        ...
        for nn = 1:positions
            ...
            images.YFP = {images.YFP{1:(end-throwout)}}';

            % CHANGE:
            timecoursedata = CovMapCellsBMH(imdir ,images, {'YFP'}, circ, imbg , siz , storeim, rad, std_thresh, times);
