...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_Project\20140604_gluc_drop\'
...
legend_vec = {'0.111M gluc, 0.5M sorb(pos cont)','0.111M gluc (neg cont)','No gluc' ,'No gluc, 0.111M sorb', '0.006M gluc', '0.006M gluc + 0.105M sorb', '0.028M gluc', '0.006M gluc + 0.083M sorb'}
...
hleg = legend(plt_grp,legend_vec(index_vec)) %,'Location','NE');
htitle = get(hleg,'Title');
%set(htitle,'String','Condition')
title('SC Glucose Dropout, No Sorb Balance')
xlabel('time')
ylabel('SC.MSN2 Nuclear Localization')
...
htitle = get(hleg,'Title');
%set(htitle,'String','Condition')
title('SC Glucose Dropout, Sorb Balance')
xlabel('time')
ylabel('SC.MSN2 Nuclear Localization')
