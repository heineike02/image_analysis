...
imdirSP.KL = 'C:\Users\Ben\Documents\Data\PKA_Project\20130923\Single_KL_Cell\'
imdirSP.SC = 'C:\Users\Ben\Documents\Data\PKA_Project\20130923\Single_SC_Cell\'
...
%Gets background image for YFP
%imbg = imread('C:\Users\Ben\Documents\Data\PKA_Project\20130923\YFP_BG100ms\img_000000000_Default_000.tif');
...
for sp = 1:length(species_cell)
    ...
    D = dir(imdir);
    %subtract 2 for the non-image files in the directory.
    nTimes = (length(D)-2)/(Nchan*positions);
    times = dt*[0:nTimes-1];
