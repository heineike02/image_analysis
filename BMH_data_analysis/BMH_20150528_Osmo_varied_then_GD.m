function all_tracks = BMH_20150528_osmo_then_GD_Hog_7_Strain76()
%
...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20150528_osmo_then_GD_Hog_7\'
...
fname_saveSP.SC = '20150528_processed_data_SC_Hog1.mat';
...
%t0 is when Osmo shock is added.
%SC 42 SC.MSN2-RFP, KL.MSN2-YFP: 
%A4 SDC t24 GD
%B4 0.25M sorb t24 GD
%C4 SDC  t36 GD
%D4 0.25M sorb t36 GD
%
%SC76 (Hog1-RFP)
%E3  SDC t24 GD
%F3  0.25M sorb t24 GD
%G3  SDC  t36 GD
%H3  0.25M sorb t36 GD


%wellvecSP.SC = {'A4','B4','C4','D4'};
wellvecSP.SC = {'E4','F4','G4','H4'};
wellvecSP.KL = {};
Nsites = 4;
...
% Some blobs in the following images, but not removed - for hog1
% E2&3 post GD 11-end
% E1 post osmo, gone after GD, frames 4-11
...
%SC 42: 
%A3 SDC t36 GD
%B3 0.25M sorb t36 GD
%C3 SDC  t48 GD
%D3 0.25M sorb t48 GD
%E3 SDC  t72 GD
%F3 0.25M sorb  t72 GD
%G3 0.125M sorb t36 GD
%H3 0.0625M sorb t36 GD

figure(1)
clf
hold on
channel = 'RFP'
legend_vec_RFP = {'t0: SDC, t36: GD',
't0: 0.25M Sorb, t36: GD', 
't0: SDC, t48: GD', 
't0: 0.25M Sorb, t48: GD', 
't0: SDC, t72: GD', 
't0: 0.25M Sorb, t72: GD', 
't0: 0.125M Sorb, t36: GD', 
't0: 0.0625M Sorb, t36: GD'}
fname_save = '20150520_processed_data_SC.mat';
...
title('SC.Msn2, Glucose Drop following Osmo Shock')
xlabel('time')
...
htitle = get(hleg,'Title');
%set(htitle,'String','Condition')
title('KL.Msn2, Glucose Dropout following Osmo Shock')
xlabel('time')
ylabel('Nuclear Localization')
%}
...
hold on
channel = 'RFP'
% legend_vec_RFP = {'SDC -> SDC + 0.25M Sorb t6',
% 'SDC -> SDC + 0.25M Sorb t18', 
% 'SDC -> SDC + 0.25M Sorb t36', 
% 'SDC -> SDC + 0.25M Sorb t48', 
% 'SDC replaced + 0.25M Sorb t6', 
% 'SDC replaced + 0.25M Sorb t18', 
% 'no change + 0.25M Sorb t6', 
% 'no change + 0.25M Sorb t18'}
fname_save = '20150410_processed_data_SC.mat';
load([base_dir,fname_save],'all_times_vec','all_tracks_vec','posvec')
% cmap = [1,0,0;  %Red
%  1,0.35,0; %light red
%  0,0,1;  %Blue
...
htitle = get(hleg,'Title');
%set(htitle,'String','Condition')
title('SC.Msn2, Osmo shock folowing media replacement')
xlabel('time')
ylabel('Nuclear Localization')
