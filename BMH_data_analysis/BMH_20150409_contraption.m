function all_tracks = BMH_20150409_contraption()
%
...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20150409_GD_osmo_contraption\'
...
fname_saveSP.SC = '20150409_processed_data_SC.mat';
...
%A5 - Glucose Dropout at time 6, Osmo shock time (0.25M Sorbitol) - time 24
%B5 - No Change
...
hold on
channel = 'RFP'
legend_vec_RFP = {'(SC.MSN2) GD t6, Sorb 0.25M t24',
'(SC.MSN2) no perturbation'}
fname_save = '20150409_processed_data_SC.mat';
...
title('SC.MSN2, using macrofluidic device')
xlabel('time')
...
hold on
channel = 'YFP'
legend_vec_YFP ={'(KL.MSN2) GD t6, Sorb 0.25M t24',
'(KL.MSN2) no perturbation'}
fname_save = '20150409_processed_data_SC.mat';
load([base_dir,fname_save],'all_times_vec','all_tracks_vec','posvec')
cmap = [1,0,0;  %Red
 0,0,0   %black
...
htitle = get(hleg,'Title');
%set(htitle,'String','Condition')
title('KL.MSN2, using macrofluidic device')
xlabel('time')
ylabel('Nuclear Localization')
%}
