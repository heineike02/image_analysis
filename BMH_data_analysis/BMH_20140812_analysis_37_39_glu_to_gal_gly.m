function all_tracks = BMH_20140812_analysis_37_39_glu_to_gal_gly()
...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20140812_37_39_glu_to_gal_gly\'
...
%B9 SC  Glu -> 3% Gly
%C9 SC Glu -> .81% Gly
%D9 SC Glu -> no glu, .111M sorb
%E9 KL (39) Glu -> 2% Gal
%F9 KL  Glu -> 3% Gly
%G9 KL Glu -> .81% Gly
%H9 KL Glu -> no glu, .111M sorb

%SC 
legend_vec =   {'Glu -> 2% Gal','Glu -> 3%Gly','Glu -> .81% Gly','Glu -> 0.111M Sorb'}; 
%{'37_1 GD','37_2 GD','38_1 GD','38_2 GD','11-38 GD','37_1 0.5M Sorb'};

%Micromanager positions: Pos0, Pos1, etc.  
%JSO positions p1,p2,etc

wellvecSP.SC = {'A9','B9','C9','D9'};
wellvecSP.KL = {'E9','F9','G9','H9'};
Nsites = 4;
...
legend_vec_RFP = {'(SC.MSN2) Glu -> 2% Gal' ;
    '(SC.MSN2) Glu -> 3%Gly';
    '(SC.MSN2) Glu -> .81% Gly';
    '(SC.MSN2) Glu -> 0.111M Sorb'
    }
...
legend_vec_GFP = {'(KL.MSN2) Glu -> 2% Gal' ;
    '(KL.MSN2) Glu -> 3%Gly';
    '(KL.MSN2) Glu -> .81% Gly';
    '(KL.MSN2) Glu -> 0.111M Sorb'
    }
...
htitle = get(hleg,'Title');
%set(htitle,'String','Condition')
title('SC: KL.MSN2 and SC.MSN2 shift from Glu')
xlabel('time')
...
legend_vec_RFP = {'(KL.MSN2) Glu -> 2% Gal' ;
    '(KL.MSN2) Glu -> 3%Gly';
    '(KL.MSN2) Glu -> .81% Gly';
    '(KL.MSN2) Glu -> 0.111M Sorb'
    }
...
legend_vec_GFP = {'(SC.MSN2) Glu -> 2% Gal' ;
    '(SC.MSN2) Glu -> 3%Gly';
    '(SC.MSN2) Glu -> .81% Gly';
    '(SC.MSN2) Glu -> 0.111M Sorb'
    }
...
htitle = get(hleg,'Title');
%set(htitle,'String','Condition')
title('KL: KL.MSN2 and SC.MSN2 shift from Glu')
xlabel('time')
ylabel('Nuclear Localization')
