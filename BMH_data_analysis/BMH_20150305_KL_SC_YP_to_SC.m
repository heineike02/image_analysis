function all_tracks = BMH_20150305_KL_SC_YP_to_SC()
...
%Should add option in code to not track cells but rather use individual
%images - for times when cell tracks are not very good. 

%Should add a bunch of diagnostics that I can turn on and off easily

%Should add something to find cells with bright field and calculate size
%with bright field. 
...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20150305_KL_SC_YP_to_SC\'
...
fname_saveSP.SC = '20150305_processed_data_SC_post.mat';
fname_saveSP.KL = '20150305_processed_data_KL_post.mat';
%fname_saveSP.SC = '20140703_processed_data_SC.mat'; 

phases =  {'Post'}%,'Post_p2'} %,'Post'} 
shift_timing = [0,10]    %shift was 10 min because of loss of focus
...
if bgimg == 0  %set default to 1
    ...
    for jj = 1:length(ch2i)
        ...
        if strcmp(ch2i_txt,'RFP')
             imbg_jj = imread([base_dir,'BG_SC\img_000000000_RFP_001.tif']);
        elseif strcmp(ch2i_txt,'YFP')
             imbg_jj = imread([base_dir,'BG_SC\img_000000000_YFP_001.tif']);
...
wellvecSP.SC = {'A12'};  %RFP_only 'C8','D8','E8'
wellvecSP.KL = {'B12'};
Nsites = 4;
...
fname_save = '20150305_processed_data_KL_post.mat'

channel = 'RFP'
legend_vec_RFP = {'Klac, KL.MSN2-RFP'}
...
channel = 'YFP'
legend_vec_YFP = {'Klac, SC.MSN2-YFP'}
...
title('KL response to switch from YP to SC')
xlabel('time')
...
fname_save = '20150305_processed_data_SC_post.mat'

channel = 'RFP'
legend_vec_RFP = {'SCer, SC.MSN2-RFP'}
...
channel = 'YFP'
legend_vec_YFP = {'Scer, KL.MSN2-YFP'}
...
htitle = get(hleg,'Title');
%set(htitle,'String','Condition')
title('SC response to switch from YP to SC')
xlabel('time')
ylabel('Nuclear Localization')
%}
