function all_tracks = BMH_20141210_GD_sorb_time_shift()
%
...
base_dir = 'C:\Users\Ben\Documents\Data\PKA_project\20141210_GD_Sorb_change_times\'
...
fname_saveSP.SC = '20141210_processed_data_SC.mat';
...
%A8 GD -> GD + 0.25M Sorb t6 
%B8 SDC -> SDC + 0.25M Sorb t6
%C8 GD -> GD + 0.25M Sorb t12
%D8 SDC -> SDC + 0.25M Sorb t12
%E8 GD -> GD + 0.25M Sorb t18
%F8 SDC -> SDC + 0.25M Sorb t18
%G8 2uM NMPP1 -> 0.25M Sorb t6 + 2uM NMPP1
%H8 2uM NMPP1 -> 0.25M Sorb t18 + 2uM NMPP1

%Micromanager positions: Pos0, Pos1, etc.  
%JSO positions p1,p2,etc

wellvecSP.SC = {'A8','B8','C8','D8', 'E8','F8','G8','H8'};  %RFP_only 'C8','D8','E8'
wellvecSP.KL = {};
Nsites = 4;
...
%Glucose dropout media balanced with 0.11M
%sorbitol
%A8 GD -> GD + 0.25M Sorb t6   
%B8 SDC -> SDC + 0.25M Sorb t6
%C8 GD -> GD + 0.25M Sorb t12
