...
#This hack swaps out bad channel names with good channel names. 
channel_nameswap = {'YFP-Wheel':'YFP_wheel','RFP-wheel':'RFP_wheel'}
...
#imdirbase =  os.path.normpath('C:\Users\Ben\Documents\Data\PKA_project\\20170106_SC_sugar_replacement\Pre') + os.sep
...
for pos in pos_names: 
    ...
    #Changes out bad channel names for good ones - only used in this hack. 
    new_channels = []
    for channel in channels: 
        try:
            new_channel = channel_nameswap[channel]
        except KeyError:
            new_channel = channel
